...
7. Xiaojun Ma, Hanyue Chen, Guojie Song*. EnergyReg: Alleviating Over-Smoothing in Graph Neural Networks with Local Energy. CIKM 2021.
8. Zheng Fang, Qingqing Long, Guojie Song*, Kunqing Xie. Spatial-Temporal Graph ODE Networks for Traffic Flow Forecasting. KDD2021.
9. Qingqing Long, Lingjun Xu, Zheng Fang, Guojie Song*. HGK-GNN: Heterogeneous Graph Kernel based Graph Neural Networks. KDD 2021.
10. Ziyao Li, Shuwen Yang, Guojie Song*. Conformation-Guided Molecular Representation with Hamiltonian Neural Networks. ICLR2021.
11. Qingqing Long, Yilun Jin, Yi Wu , Guojie Song*. Theoretically Improving Graph Neural Networks via Anonymous Walk Graph Kernels. The Web Conference 2021.
12. Xiaojun Ma,Junshan Wang, Hanyue Zhang, Guojie Song*. Improving Graph Neural Networks with Structural Adaptive Receptive Fields. The Web Conference 2021.
13. Yiding Zhang, Xiao Wang, Chuan Shi, Nian Liu and Guojie Song. Lorentzian Graph Convolutional Networks. The Web Conference 2021.
14. Chen Li, Linmei Hu, Chuan Shi, Guojie Song, Yuanfu Lu: Sequence-aware Heterogeneous Graph Neural Collaborative Filtering. SDM2021.
